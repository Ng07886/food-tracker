...
var AppResolver = (function () {
    function AppResolver(appService, firestoreService) {
        this.appService = appService;
        this.firestoreService = firestoreService;
    }
    AppResolver.prototype.searchFoods = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.appService.getFoods(userId)];
            });
        });
    };
    __decorate([
    ...
    ], AppResolver.prototype, "searchFoods", null);
